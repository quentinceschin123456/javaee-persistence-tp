...
<%
    String newText, currentText = "",dateUpdate;
    ...
    try {
        ...
        lastUpdateDate = new SimpleDateFormat().format(l.getLastDate());
    }catch (Exception e){
        e.printStackTrace();
    }
 %>   
<html>
    ...
    <body>
        ...
        <a href="/EnglishLessons/basique/page2.jsp">Voir La Page 2</a>
